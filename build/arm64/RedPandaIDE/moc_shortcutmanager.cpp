...
#include "../../../RedPandaIDE/shortcutmanager.h"
...
static constexpr auto qt_meta_stringdata_ZN15ShortcutManagerE = QtMocHelpers::stringData(
    "ShortcutManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15ShortcutManagerE[] = {
...
Q_CONSTINIT const QMetaObject ShortcutManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15ShortcutManagerE.offsetsAndSizes,
    qt_meta_data_ZN15ShortcutManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ShortcutManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void *ShortcutManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15ShortcutManagerE.stringdata0))
